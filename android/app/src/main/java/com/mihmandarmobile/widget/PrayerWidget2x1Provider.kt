...
class PrayerWidget2x1Provider : AppWidgetProvider() {

    companion object {
        const val ACTION_WIDGET_CLICK = "com.mihmandarmobile.widget.2x1.WIDGET_CLICK"
        const val ACTION_REFRESH = "com.mihmandarmobile.widget.2x1.REFRESH"
    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_REFRESH -> {
                ...
                val componentName = ComponentName(context, PrayerWidget2x1Provider::class.java)
    ...
    private fun updateWidget(context: Context, manager: AppWidgetManager, appWidgetId: Int) {
        val views = RemoteViews(context.packageName, com.mihmandarmobile.R.layout.prayer_widget_2x1)
    ...
    private fun setupClickIntents(context: Context, views: RemoteViews, appWidgetId: Int) {
        val clickIntent = Intent(context, PrayerWidget2x1Provider::class.java).apply {
    ...
    private fun scheduleNextUpdate(context: Context, manager: AppWidgetManager, appWidgetId: Int) {
        val updateIntent = Intent(context, PrayerWidget2x1Provider::class.java).apply {
