...
class PrayerWidget3x2Provider : AppWidgetProvider() {

    companion object {
        const val ACTION_WIDGET_CLICK = "com.mihmandarmobile.widget.3x2.WIDGET_CLICK"
        const val ACTION_REFRESH = "com.mihmandarmobile.widget.3x2.REFRESH"
    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_REFRESH -> {
                ...
                val componentName = ComponentName(context, PrayerWidget3x2Provider::class.java)
    ...
    private fun updateWidget(context: Context, manager: AppWidgetManager, appWidgetId: Int) {
        val views = RemoteViews(context.packageName, com.mihmandarmobile.R.layout.prayer_widget_3x2)
    ...
    private fun setupClickIntents(context: Context, views: RemoteViews, appWidgetId: Int) {
        val clickIntent = Intent(context, PrayerWidget3x2Provider::class.java).apply {
        ...
        val refreshIntent = Intent(context, PrayerWidget3x2Provider::class.java).apply {
        ...
        for ((name, time) in prayerTimes) {
            ...
            if (prayerTotalSeconds > currentTotalSeconds) {
                ...
                val remainingText = when {
                    hours > 0 -> "${hours}s ${minutes}dk ${seconds}sn kaldı"
                    minutes > 0 -> "${minutes}dk ${seconds}sn kaldı"
                    else -> "${seconds}sn kaldı"
                }
